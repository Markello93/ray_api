...
from config.settings import POST_STRING_SIZE
...
class Post(models.Model):
    ...
    image = models.ImageField(verbose_name='Изображение коллекции', default='posts/noimage_detail.png', blank=True, null=True)
